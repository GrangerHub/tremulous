...
static int GLSL_InitGPUShader2(
    shaderProgram_t *program, const char *name, int attribs, const char *vpCode, const char *fpCode)
{
    ...
    if (fpCode)
    {
        if (!(GLSL_CompileGPUShader(
                program->program, &program->fragmentShader, fpCode, strlen(fpCode), GL_FRAGMENT_SHADER)))
        {
...
static int GLSL_InitGPUShader(shaderProgram_t *program, const char *name, int attribs, bool fragmentShader,
    const GLchar *extra, bool addHeader, const char *fallback_vp, const char *fallback_fp)
{
    char vpCode[32000];
    char fpCode[32000];
    char *postHeader;
...
void GLSL_SetUniformInt(shaderProgram_t *program, int uniformNum, GLint value)
{
    ...
    {
        ri.Printf(
            PRINT_WARNING, "GLSL_SetUniformInt: wrong type for uniform %i in program %s\n", uniformNum, program->name);
        return;
    }
...
void GLSL_SetUniformVec2(shaderProgram_t *program, int uniformNum, const vec2_t v)
{
    ...
    {
        ri.Printf(
            PRINT_WARNING, "GLSL_SetUniformVec2: wrong type for uniform %i in program %s\n", uniformNum, program->name);
        return;
    }
...
void GLSL_SetUniformVec3(shaderProgram_t *program, int uniformNum, const vec3_t v)
{
    ...
    {
        ri.Printf(
            PRINT_WARNING, "GLSL_SetUniformVec3: wrong type for uniform %i in program %s\n", uniformNum, program->name);
        return;
    }
...
void GLSL_SetUniformVec4(shaderProgram_t *program, int uniformNum, const vec4_t v)
{
    ...
    {
        ri.Printf(
            PRINT_WARNING, "GLSL_SetUniformVec4: wrong type for uniform %i in program %s\n", uniformNum, program->name);
        return;
    }
...
void GLSL_SetUniformMat4(shaderProgram_t *program, int uniformNum, const mat4_t matrix)
{
    ...
    {
        ri.Printf(
            PRINT_WARNING, "GLSL_SetUniformMat4: wrong type for uniform %i in program %s\n", uniformNum, program->name);
        return;
    }
...
void GLSL_InitGPUShaders(void)
{
    ...
    if (!GLSL_InitGPUShader(&tr.pshadowShader, "pshadow", attribs, true, extradefines, true, fallbackShader_pshadow_vp,
    ...
    if (!GLSL_InitGPUShader(&tr.down4xShader, "down4x", attribs, true, extradefines, true, fallbackShader_down4x_vp,
    ...
    if (!GLSL_InitGPUShader(&tr.bokehShader, "bokeh", attribs, true, extradefines, true, fallbackShader_bokeh_vp,
    ...
    if (!GLSL_InitGPUShader(&tr.tonemapShader, "tonemap", attribs, true, extradefines, true, fallbackShader_tonemap_vp,
    ...
    // gamma post-processing shader
    attribs = ATTR_POSITION | ATTR_TEXCOORD;
    extradefines[0] = '\0';

    if (!GLSL_InitGPUShader(&tr.gammaShader, "gamma", attribs, true, extradefines, true, fallbackShader_gamma_vp,
            fallbackShader_gamma_fp))
    {
    ...
    if (!GLSL_InitGPUShader(
            &tr.ssaoShader, "ssao", attribs, true, extradefines, true, fallbackShader_ssao_vp, fallbackShader_ssao_fp))
    {
