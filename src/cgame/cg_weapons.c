...
void CG_RegisterWeapon(int weaponNum)
{
    ...
    if (!CG_ParseWeaponAnimationFile(path, weaponInfo))
        Com_Printf(S_COLOR_YELLOW "WARNING: failed to parse %s\n", path);
...
===============
*/
static qboolean CG_WeaponSelectable(weapon_t weapon) { return BG_InventoryContainsWeapon(weapon, cg.snap->ps.stats); }
