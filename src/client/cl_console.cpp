...
void Con_Init (void) {
	...
	Cvar_CheckRange (con_colorBlue, 0, 1, false);
	...
	Cvar_CheckRange (con_colorGreen, 0, 1, false);
	...
	Cvar_CheckRange (con_colorAlpha, 0, 1, false);
