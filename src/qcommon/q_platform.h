...
#if defined(__GNUC__)
// idx64 enables the GCC-inline-asm optimized paths in q_shared.h
// (qsnapvectorsse etc., provided by src/asm/snapvector.c). MSVC uses
// different inline-asm syntax, so on MSVC builds we leave idx64
// undefined and fall through to the portable C versions of
// Q_ftol / Q_SnapVector in q_shared.h.
#undef idx64
#define idx64 1
#endif
...
#if defined(_M_X64) || defined(__WIN64__) || defined(__x86_64__)
